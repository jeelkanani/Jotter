...
import { useRef } from 'react';  //koy pn ek element ne referal day shakay
  ...
  <div className="mb-3">
    ...
    <input type="text" className="form-control" id="etag" name="etag" value={note.etag} onChange={onchange}/>
            ...
            <div className="modal-footer">
              ...
              <button  disabled={note.etitle.length<5 || note.edescription.length<5} type="button" className="btn btn-primary" onClick={handleclick}>Upadate Note</button>
            </div>
          </div>
        </div>
      </div>
